...
namespace lr3.Tests
{
    ...
    public class GridTests
    {
        ...
        public void GridOutOfRangeRightUpAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки справа сверху вне границ. Ожидается остановка обращения к индексу вне границ сетки.");
            }
        }
        ...
        public void GridRightAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки справа. Ожидается " + expected + ". Фактически " + actual[cell_row, cell_column + 1] + " .");
            }
        }
        ...
        public void GridOutOfRangeRightAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки справа вне границ. Ожидается остановка обращения к индексу вне границ сетки.");
            }
        }
        ...
        public void GridRightDownAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки справа снизу. Ожидается " + expected + ". Фактически " + actual[cell_row + 1, cell_column + 1] + " .");
            }
        }
        ...
        public void GridOutOfRangeRightDownAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки справа снизу вне границ. Ожидается остановка обращения к индексу вне границ сетки.");
            }
        }
        ...
        public void GridOutOfRangeDownAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки снизу вне границ. Ожидается остановка обращения к индексу вне границ сетки.");
            }
        }
        ...
        public void GridLeftDownAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки слева снизу. Ожидается " + expected + ". Фактически " + actual[cell_row + 1, cell_column - 1] + " .");
            }
        }
        ...
        public void GridOutOfRangeLeftDownAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки слева снизу вне границ. Ожидается остановка обращения к индексу вне границ сетки.");
            }
        }
        ...
        public void GridLeftAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки слева. Ожидается " + expected + ". Фактически " + actual[cell_row, cell_column - 1] + " .");
            }
        }
        ...
        public void GridLeftUpAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки слева сверху. Ожидается " + expected + ". Фактически " + actual[cell_row - 1, cell_column - 1] + " .");
            }
        }
        ...
        public void GridOutOfRangeLeftUpAdjacentIncTest()
        {
            ...
            {
                throw new AssertFailedException("Сбой увеличения значения соседней ячейки слева сверху вне границ. Ожидается остановка обращения к индексу вне границ сетки.");
            }
        }
    }
}